          ...
          if (response.ok) {
            ...
            if (data.success) {
              ...
              const updatedPortals = savedPortals.map((portal: any, index: number) => {
                ...
                const lastMessage = messageData.length > 0 ? messageData[0].message : 'No messages yet';
                const lastMessageTime = messageData.length > 0 ? messageData[0].created_at : '';
                const lastMessageId = messageData.length > 0 ? messageData[0].id : null;
