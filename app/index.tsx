    ...
    >
      ...
      >
        <View className="flex-1 bg-white">
          <ImageBackground source={require('../assets/background/bg-8.jpg')} className="flex-1">
            <View className="flex-1 p-8">
              <Animated.View className="flex-1 justify-center mt-[50]" style={{ opacity: fadeAnim }}>
                ...
                <Animated.View style={{ transform: [{ translateY: slideAnim }] }}>
                  ...
                  <View className="bg-orange-100/50 rounded-2xl overflow-hidden">
                  ...
                  <View className="flex-row justify-between items-center px-2 py-3">
                    ...
                    >
                      ...
                      <Text className="text-orange-700 ml-3 text-sm">Remember Me</Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                      ...
                      disabled={isLoggingIn}
                    >
                      <Text className="text-orange-700 text-sm">Forgot Password?</Text>
                    </TouchableOpacity>
                  </View>
